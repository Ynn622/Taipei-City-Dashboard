...
202	food_safety_market_ntpe	新北市公有市場	circle	geojson	big	\N	{"circle-color":"#F5B041","circle-opacity":0.75,"circle-stroke-color":"#FFF8E8","circle-stroke-width":1}	[{"key":"name","name":"市場名稱"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"phone","name":"電話"},{"key":"type","name":"市場型態"}]
\.
