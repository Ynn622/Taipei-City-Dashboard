...
food_safety_market	{#30B68F,#F5B041}	{MapLegend}	處
food_safety_logistics_vendor	{#4A90E2,#D84C73}	{MapLegend}	處
food_safety_health_office	{#2F7D6D,#C2573E}	{MapLegend}	處
\.
...
201	food_safety_market_tpe	臺北市公有市場	circle	geojson	big	\N	{"circle-color":"#30B68F","circle-radius":["interpolate",["linear"],["coalesce",["to-number",["get","stall_total"]],1],0,4,50,6,150,9,300,13,500,17],"circle-opacity":0.72,"circle-stroke-color":"#F7FFF9","circle-stroke-width":1}	[{"key":"name","name":"市場名稱"},{"key":"district","name":"行政區"},{"key":"stall_total","name":"總攤位數"},{"key":"vegetable_stalls","name":"蔬菜攤位"},{"key":"fruit_stalls","name":"青果攤位"},{"key":"meat_stalls","name":"獸肉攤位"},{"key":"seafood_stalls","name":"漁產攤位"},{"key":"poultry_stalls","name":"家禽攤位"},{"key":"grain_stalls","name":"糧食攤位"},{"key":"flower_stalls","name":"花卉攤位"},{"key":"grocery_stalls","name":"雜貨攤位"},{"key":"general_merchandise_stalls","name":"百貨攤位"},{"key":"food_stalls","name":"飲食攤位"},{"key":"other_stalls","name":"其他攤位"}]
202	food_safety_market_ntpe	新北市公有市場	circle	geojson	big	\N	{"circle-color":"#F5B041","circle-radius":["interpolate",["linear"],["coalesce",["to-number",["get","stall_total"]],80],0,4,50,6,150,9,300,13,500,17],"circle-opacity":0.72,"circle-stroke-color":"#FFF8E8","circle-stroke-width":1}	[{"key":"name","name":"市場名稱"},{"key":"district","name":"行政區"},{"key":"stall_total","name":"總攤位數"},{"key":"produce_stalls","name":"果菜攤位"},{"key":"meat_stalls","name":"畜肉攤位"},{"key":"seafood_stalls","name":"魚蝦攤位"},{"key":"poultry_stalls","name":"禽肉攤位"},{"key":"grain_stalls","name":"糧食攤位"},{"key":"grocery_stalls","name":"雜貨攤位"},{"key":"flower_stalls","name":"花卉攤位"},{"key":"food_stalls","name":"飲食攤位"},{"key":"general_merchandise_stalls","name":"百貨攤位"},{"key":"other_stalls","name":"其他攤位"},{"key":"vacant_stalls","name":"空攤"},{"key":"address","name":"地址"},{"key":"phone","name":"電話"},{"key":"type","name":"市場型態"}]
203	food_safety_logistics_vendor_tpe	臺北市食品物流業者	circle	geojson	big	\N	{"circle-color":"#4A90E2","circle-radius":5,"circle-opacity":0.72,"circle-stroke-color":"#F3F8FF","circle-stroke-width":1}	[{"key":"name","name":"業者名稱"},{"key":"registration_no","name":"食品業者登錄字號"},{"key":"company_registration_name","name":"公司/商業登記名稱"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"FDA地址"},{"key":"vendor_category","name":"業者分類"},{"key":"registration_item","name":"登錄項目"}]
204	food_safety_logistics_vendor_ntpe	新北市食品物流業者	circle	geojson	big	\N	{"circle-color":"#D84C73","circle-radius":5,"circle-opacity":0.72,"circle-stroke-color":"#FFF2F6","circle-stroke-width":1}	[{"key":"name","name":"業者名稱"},{"key":"registration_no","name":"食品業者登錄字號"},{"key":"company_registration_name","name":"公司/商業登記名稱"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"FDA地址"},{"key":"vendor_category","name":"業者分類"},{"key":"registration_item","name":"登錄項目"}]
205	food_safety_health_office_tpe	臺北市衛生局與健康服務中心	circle	geojson	big	\N	{"circle-color":"#2F7D6D","circle-radius":["case",["==",["get","agency_type"],"衛生局"],11,7],"circle-opacity":0.78,"circle-stroke-color":"#E9FFF8","circle-stroke-width":["case",["==",["get","agency_type"],"衛生局"],2,1.2]}	[{"key":"name","name":"名稱"},{"key":"agency_type","name":"類型"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"phone","name":"電話"},{"key":"website","name":"網址"}]
206	food_safety_health_office_ntpe	新北市衛生局與衛生所	circle	geojson	big	\N	{"circle-color":"#C2573E","circle-radius":["case",["==",["get","agency_type"],"衛生局"],11,7],"circle-opacity":0.78,"circle-stroke-color":"#FFF1EC","circle-stroke-width":["case",["==",["get","agency_type"],"衛生局"],2,1.2]}	[{"key":"name","name":"名稱"},{"key":"agency_type","name":"類型"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"phone","name":"電話"},{"key":"extension","name":"分機"},{"key":"zipcode","name":"郵遞區號"},{"key":"open_time","name":"服務時間"}]
\.
...
305	food_safety_health_office	衛生局
\.
...
401	food_safety_health_tpe	食安健康	{303,304,305}	restaurant	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00
402	food_safety_health_metrotaipei	食安健康	{303,304,305}	restaurant	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00
...
food_safety_market	\N	{201,202}	{}	static	\N	\N	\N	臺北市市場處、新北市政府市場處	顯示雙北公有市場分布。	顯示臺北市各區公有零售市(商)場與新北市公有市場名冊之空間分布。臺北資料包含市場名稱、行政區與各營業種類攤位數，新北資料包含市場名稱、行政區、地址、電話與市場型態；資料經批次地理編碼後轉為地圖點位，提供市場分布與食安巡檢、公共衛生資源配置的基礎圖資。	可用於食安稽查排程、市場周邊公共衛生服務配置、跨區市場分布比較，以及與人口、交通、醫療或災防圖層套疊分析，協助掌握民生採買場域與健康風險管理的空間關係。	{https://data.taipei/dataset/detail?id=f490476d-d156-4492-a463-cf3405de3b55,https://data.ntpc.gov.tw/datasets/785be91a-caaf-4e1c-91d6-f7d616d31a45}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	map_legend	SELECT unnest(array['臺北市公有市場','新北市公有市場']) as name, unnest(array['circle','circle']) as type, unnest(array[45,43]) as value	\N	metrotaipei
food_safety_market	\N	{201}	{}	static	\N	\N	\N	臺北市市場處	顯示臺北市公有市場分布。	顯示臺北市各區公有零售市(商)場之空間分布，包含市場名稱、行政區與各營業種類攤位數；資料經批次地理編碼後轉為地圖點位，提供市場分布與食安巡檢、公共衛生資源配置的基礎圖資。	可用於食安稽查排程、市場周邊公共衛生服務配置、行政區市場分布比較，以及與人口、交通、醫療或災防圖層套疊分析。	{https://data.taipei/dataset/detail?id=f490476d-d156-4492-a463-cf3405de3b55}	{doit}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	map_legend	SELECT unnest(array['臺北市公有市場']) as name, unnest(array['circle']) as type, unnest(array[45]) as value	\N	taipei
food_safety_logistics_vendor	\N	{203,204}	{}	static	\N	\N	\N	衛生福利部食品藥物管理署	顯示雙北食品物流業者行政區分布。	顯示 FDA 食品業者登錄中分類為物流業的雙北業者分布；資料由縣市列表端點以 tp=6 抓取，因來源未提供業者經緯度，臺北市地圖先以臺北市門牌位置數值資料定位，未成功者再使用地址轉座標與 OpenStreetMap 道路/地名定位，最後才以行政區中心點加微小偏移顯示每筆業者，並提供業者名稱、登錄字號、地址等欄位。	可用於食安物流節點分布盤點、稽查資源配置、行政區風險熱點比較，以及與市場、人口、交通圖層套疊分析。	{https://fadenbook.fda.gov.tw/pub/search-Vendor-County-result.aspx?city=%E8%87%BA%E5%8C%97%E5%B8%82,https://fadenbook.fda.gov.tw/pub/search-Vendor-County-result.aspx?city=%E6%96%B0%E5%8C%97%E5%B8%82}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	map_legend	SELECT unnest(array['臺北市食品物流業者','新北市食品物流業者']) as name, unnest(array['circle','circle']) as type, unnest(array[256,479]) as value	\N	metrotaipei
food_safety_logistics_vendor	\N	{203}	{}	static	\N	\N	\N	衛生福利部食品藥物管理署	顯示臺北市食品物流業者行政區分布。	顯示 FDA 食品業者登錄中分類為物流業的臺北市業者分布；資料由縣市列表端點以 tp=6 抓取，因來源未提供業者經緯度，地圖先以臺北市門牌位置數值資料定位，未成功者再使用地址轉座標與 OpenStreetMap 道路/地名定位，最後才以行政區中心點加微小偏移顯示每筆業者，並提供業者名稱、登錄字號、地址等欄位。	可用於食安物流節點分布盤點、稽查資源配置、行政區風險熱點比較，以及與市場、人口、交通圖層套疊分析。	{https://fadenbook.fda.gov.tw/pub/search-Vendor-County-result.aspx?city=%E8%87%BA%E5%8C%97%E5%B8%82}	{doit}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	map_legend	SELECT unnest(array['臺北市食品物流業者']) as name, unnest(array['circle']) as type, unnest(array[256]) as value	\N	taipei
food_safety_health_office	\N	{205,206}	{}	static	\N	\N	\N	臺北市政府衛生局、新北市政府衛生局	顯示雙北衛生局所屬服務據點分布。	顯示臺北市政府衛生局、臺北市健康服務中心、新北市政府衛生局與新北市各區衛生所之空間分布，包含名稱、行政區、地址、電話、服務時間或網站等資訊；臺北市點位優先使用臺北市門牌位置數值資料定位，新北市點位使用 OpenStreetMap 道路/地名定位。	可用於食安稽查支援、衛生服務據點查找、公共衛生資源配置、食品安全事件應變聯絡與跨區服務覆蓋分析。	{https://data.gov.tw/dataset/121146,https://data.gov.tw/dataset/125693,https://health.gov.taipei/,https://www.health.ntpc.gov.tw/}	{doit,ntpc}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	map_legend	SELECT unnest(array['臺北市衛生局/健康服務中心','新北市衛生局/衛生所']) as name, unnest(array['circle','circle']) as type, unnest(array[13,30]) as value	\N	metrotaipei
food_safety_health_office	\N	{205}	{}	static	\N	\N	\N	臺北市政府衛生局	顯示臺北市政府衛生局與健康服務中心分布。	顯示臺北市政府衛生局與各區健康服務中心之空間分布，包含名稱、行政區、地址、電話與網站等資訊；點位優先使用臺北市門牌位置數值資料定位。	可用於食安稽查支援、衛生服務據點查找、公共衛生資源配置與食品安全事件應變聯絡。	{https://data.gov.tw/dataset/121146,https://health.gov.taipei/}	{doit}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	map_legend	SELECT unnest(array['臺北市衛生局/健康服務中心']) as name, unnest(array['circle']) as type, unnest(array[13]) as value	\N	taipei
