...
SET short_desc = '顯示雙北食品物流業者行政區分布。',
    long_desc = '顯示 FDA 食品業者登錄中分類為物流業的雙北業者行政區分布，並以行政區圖、矩形圖與橫向長條圖呈現各行政區業者數量。資料由縣市列表端點以 tp=6 抓取，因來源未提供業者經緯度，臺北市地圖先以臺北市門牌位置數值資料定位，未成功者再使用地址轉座標與 OpenStreetMap 道路/地名定位，最後才以行政區中心點加微小偏移顯示每筆業者，並提供業者名稱、登錄字號、地址等欄位。',
    query_type = 'two_d',
...
SET short_desc = '顯示臺北市食品物流業者行政區分布。',
    long_desc = '顯示 FDA 食品業者登錄中分類為物流業的臺北市業者行政區分布，並以行政區圖、矩形圖與橫向長條圖呈現各行政區業者數量。資料由縣市列表端點以 tp=6 抓取，因來源未提供業者經緯度，地圖先以臺北市門牌位置數值資料定位，未成功者再使用地址轉座標與 OpenStreetMap 道路/地名定位，最後才以行政區中心點加微小偏移顯示每筆業者，並提供業者名稱、登錄字號、地址等欄位。',
    query_type = 'two_d',
