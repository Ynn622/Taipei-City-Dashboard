...
VALUES
('post_help_agency', '{#2563EB,#0F766E,#F59E0B,#7C3AED,#E11D48,#0891B2,#65A30D,#DB2777,#9333EA,#EA580C,#475569,#16A34A,#DC2626,#0284C7,#7C2D12,#4B5563}', '{TreemapChart,BarChart}', '處')
...
VALUES
(215, 'post_help_agency_tpe', '臺北市事後求助機構', 'circle', 'geojson', 'big', NULL, '{"circle-color":["case",["==",["get","agency_group"],"民間保護機構"],"#E11D48","#2563EB"],"circle-radius":["interpolate",["linear"],["coalesce",["to-number",["get","specialty_count"]],1],1,5,2,7,4,10],"circle-opacity":0.76,"circle-stroke-color":["case",["==",["get","agency_group"],"民間保護機構"],"#FFF1F2","#EFF6FF"],"circle-stroke-width":1.2}', '[{"key":"name","name":"名稱"},{"key":"agency_group","name":"大類"},{"key":"agency_type","name":"類型"},{"key":"specialties","name":"科別/服務"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"phone","name":"電話"},{"key":"is_nhi_contracted","name":"健保特約"}]'),
(216, 'post_help_agency_ntpe', '新北市事後求助機構', 'circle', 'geojson', 'big', NULL, '{"circle-color":["case",["==",["get","agency_group"],"民間保護機構"],"#E11D48","#2563EB"],"circle-radius":["interpolate",["linear"],["coalesce",["to-number",["get","specialty_count"]],1],1,5,2,7,4,10],"circle-opacity":0.76,"circle-stroke-color":["case",["==",["get","agency_group"],"民間保護機構"],"#FFF1F2","#EFF6FF"],"circle-stroke-width":1.2}', '[{"key":"name","name":"名稱"},{"key":"agency_group","name":"大類"},{"key":"agency_type","name":"類型"},{"key":"specialties","name":"科別/服務"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"phone","name":"電話"},{"key":"is_nhi_contracted","name":"健保特約"}]')
