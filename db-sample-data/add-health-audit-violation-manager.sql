...
VALUES
('health_audit_violation', '{#8E44AD,#C2185B,#7E57C2,#D84C73,#5B2C6F,#F3C3D3,#A855F7,#DB2777}', '{DistrictChart,TreemapChart,BarChart}', '個')
...
VALUES
(213, 'health_audit_violation_tpe', '臺北市衛生稽核違規單位', 'circle', 'geojson', 'big', NULL, '{"circle-color":"#8E44AD","circle-radius":["interpolate",["linear"],["zoom"],9,3,12,4,15,6],"circle-opacity":0.78,"circle-stroke-color":"#FAF5FF","circle-stroke-width":1.4}', '[{"key":"name","name":"業者名稱"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"audit_date","name":"稽查日期"},{"key":"business_category","name":"業者類別"},{"key":"inspection_result","name":"稽查結果"},{"key":"violation_reason","name":"違規說明"},{"key":"phone","name":"電話"}]'),
(214, 'health_audit_violation_ntpe', '新北市衛生稽核違規單位', 'circle', 'geojson', 'big', NULL, '{"circle-color":"#C2185B","circle-radius":["interpolate",["linear"],["zoom"],9,3,12,4,15,6],"circle-opacity":0.78,"circle-stroke-color":"#FFF1F7","circle-stroke-width":1.4}', '[{"key":"name","name":"業者名稱"},{"key":"city","name":"縣市"},{"key":"district","name":"行政區"},{"key":"address","name":"地址"},{"key":"audit_date","name":"稽查日期"},{"key":"business_category","name":"業者主業別"},{"key":"inspection_result","name":"稽查結果"},{"key":"violation_reason","name":"違規說明"}]')
...
VALUES (309, 'health_audit_violation', '食品衛生稽查結果統計')
ON CONFLICT (id) DO UPDATE
SET index = EXCLUDED.index,
    name = EXCLUDED.name;
