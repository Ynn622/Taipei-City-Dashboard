...
('water_quality', '{#1E88E5,#00A6A6}', '{MapLegend}', '座')
...
('water_quality', NULL, '{207,208}', '{}', 'static', NULL, NULL, NULL, '臺北市政府主計處、臺灣自來水股份有限公司', '顯示雙北淨水場水質分布。', '顯示臺北自來水淨水場清水水質年度統計，以及臺灣自來水公司平均水質中關鍵字為新北市的淨水場最新測值；包含 pH、濁度、自由有效餘氯、總硬度、總溶解固體量與大腸桿菌群等欄位，並以淨水場點位呈現在地圖上。', '可用於掌握飲用水供應節點水質狀態，與市場、食品物流、衛生服務據點套疊，支援食安健康監測、跨區供水風險盤點與公共衛生應變。', '{https://data.taipei/dataset/detail?id=9626c65d-8fe7-45bb-bbe2-7439bed81010,https://www.water.gov.tw/ch/WaterQuality?nodeId=4631}', '{doit,ntpc}', NOW(), NOW(), 'map_legend', 'SELECT unnest(array[''臺北市淨水場'',''新北市淨水場'']) as name, unnest(array[''circle'',''circle'']) as type, unnest(array[5,6]) as value', NULL, 'metrotaipei'),
('water_quality', NULL, '{207}', '{}', 'static', NULL, NULL, NULL, '臺北市政府主計處', '顯示臺北市淨水場水質分布。', '顯示臺北自來水淨水場清水水質年度統計，包含 pH、濁度、自由有效餘氯、總硬度、總溶解固體量與大腸桿菌群等欄位，並以淨水場點位呈現在地圖上。', '可用於掌握臺北飲用水供應節點水質狀態，與市場、食品物流、衛生服務據點套疊，支援食安健康監測與公共衛生應變。', '{https://data.taipei/dataset/detail?id=9626c65d-8fe7-45bb-bbe2-7439bed81010}', '{doit}', NOW(), NOW(), 'map_legend', 'SELECT unnest(array[''臺北市淨水場'']) as name, unnest(array[''circle'']) as type, unnest(array[5]) as value', NULL, 'taipei');
