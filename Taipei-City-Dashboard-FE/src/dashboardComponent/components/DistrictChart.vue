      ...
      >
        ...
        >
          <path
            ...
            :fill-opacity="districtData['新莊區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['新莊區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['淡水區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['淡水區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['汐止區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['汐止區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['板橋區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['板橋區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['三重區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['三重區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['樹林區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['樹林區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['土城區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['土城區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['蘆洲區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['蘆洲區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['中和區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['中和區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['永和區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['永和區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['新店區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['新店區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['鶯歌區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['鶯歌區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['三峽區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['三峽區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['瑞芳區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['瑞芳區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['五股區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['五股區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['泰山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['泰山區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['林口區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['林口區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['深坑區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['深坑區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['石碇區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['石碇區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['坪林區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['坪林區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['三芝區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['三芝區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['石門區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['石門區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['八里區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['八里區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['平溪區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['平溪區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['雙溪區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['雙溪區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['貢寮區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['貢寮區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['金山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['金山區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['萬里區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['萬里區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['烏來區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['烏來區'] / districtData.highest)"
            :fill="districtColor"
        ...
        >
          <path
            ...
            :fill-opacity="districtData['北投區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['北投區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['士林區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['士林區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['內湖區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['內湖區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['中山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['中山區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['大同區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['大同區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['中正區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['中正區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['萬華區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['萬華區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['大安區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['大安區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['信義區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['信義區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['松山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['松山區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['南港區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['南港區'] / districtData.highest)"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtData['文山區'] === 0 && districtData.highest === 0 ? 0.12 : Math.max(0.12, districtData['文山區'] / districtData.highest)"
            :fill="districtColor"
